...
function getCurrentObject(_pntr) {
  const pntr = _pntr || pointer; // if pointer events are required on the very first frame or without a game
...
var _kontra = _interopRequireDefault(require("kontra"));
...
_kontra.default.init();

_kontra.default.initKeys();

var sprites = [];
socket.on("update", function (data) {
  sprites = data.map(function (item) {
    return shipFactory(item);
  });
  console.log("update", sprites);
});

var loop = _kontra.default.GameLoop({
  update: function update() {
    sprites.forEach(function (item) {
      item === null || item === void 0 ? void 0 : item.update();
    });
  },
  render: function render() {
    sprites.forEach(function (item) {
      item === null || item === void 0 ? void 0 : item.render();
    });
  }
});
...
function createNew() {
  var ship = _kontra.default.Sprite({
    x: 300,
    y: 100,
    width: 40,
    height: 10,
    ...
    id: Date.now(),
    update: function update() {
      if (_kontra.default.keyPressed("left")) {
        this.rotation += -0.04;
      } else if (_kontra.default.keyPressed("right")) {
        this.rotation += 0.04;
      }
      ...
      if (_kontra.default.keyPressed("up")) {
        this.ddx = cos * 0.05;
        this.ddy = sin * 0.05;
      } else {
        this.ddx = this.ddy = 0;
...
},{"kontra":"../node_modules/kontra/kontra.mjs","socket.io-client":"../node_modules/socket.io-client/lib/index.js","./styles.css":"styles.css"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
